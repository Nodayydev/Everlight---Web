...
## Tulajdonosi moderáció

A weboldal tulajdonosának beállítása környezeti változóval történik:

`EVERLIGHT_OWNER_USERNAME=Nodayy#0614`

A pontos értéket a tényleges tulajdonosi `username`-re kell állítani. A tulajdonos bejelentkezve törölheti a feed bármely bejegyzését, beleértve a névtelen bejegyzéseket is.

A feed közzététele bejelentkezés nélkül is engedélyezett. A bejelentkezésnél az e-mail cím opcionális.
